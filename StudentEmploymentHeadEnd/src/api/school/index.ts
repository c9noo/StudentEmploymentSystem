...
// 删除企业
export const reqDeleteTeacher = (id:string) => request.delete<SyntaxError,any>(API.DELETETEACHER_URL + `?id=${id}`)
// 批量删除老师
export const reqDeleteBatchTeacher = (id:any) => request.delete<any,any>(API.DELETEBATCH_URL + `?id=${id.value}`)
// 修改老师状态
